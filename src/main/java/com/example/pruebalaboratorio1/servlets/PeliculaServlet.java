    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        switch (action) {
            ...
            case "borrar":
                ...
                int idPeliculaEliminar = Integer.parseInt(request.getParameter("idDelete"));

                peliculaDao daoPelicula = new peliculaDao();

                daoPelicula.borrarPelicula(idPeliculaEliminar);
